...
const ChatList = ({ comments, isAdminMode, onDelete, onUpdate }) => {
    ...
    return (
        // ADDED: min-h-0 to allow flex scroll to work properly within flex container
        <div className="flex-1 overflow-y-auto min-h-0 p-4 space-y-4 bg-black/90 backdrop-blur-sm vesanico-scroll w-full">
    ...
    if (isExpanded) {
        ...
        return (
            <div className="fixed bottom-24 right-4 md:right-8 w-[90vw] md:w-96 z-50 flex flex-col shadow-2xl border border-[#1a1a1a] animate-slide-up h-[500px] max-h-[70vh]">
                ...
                {/* ADDED: overflow-hidden to allow inner scroll */}
