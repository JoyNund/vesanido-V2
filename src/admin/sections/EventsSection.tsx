...
import { eventsService, uploadService } from '../../services/api';
...
export default function EventsSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingItem) {
        await eventsService.update(editingItem.id, eventData);
      } else {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-3xl font-display tracking-wide uppercase">Eventos</h2>
        <button
          onClick={() => openModal()}
          ...
          <table className="w-full">
            <thead className="bg-[#0f0f13] border-b border-gray-800">
              <tr>
                ...
                <th className="text-left p-4 text-sm text-gray-400 font-medium hidden md:table-cell">Hora</th>
              ...
              {events.length === 0 ? (
                ...
                events.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-sm text-gray-400 hidden md:table-cell">{item.time}</td>
                    <td className="p-4">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0f0f13] border border-gray-700 rounded-lg focus:outline-none focus:border-[#d90429]"
                  placeholder="live, concierto, rock"
                />
              </div>
